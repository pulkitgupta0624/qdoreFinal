...
const PlantersAndVases = () => {
    const products = [
        { id: "mercury-planter-planter", name: "MERCURY PLANTER", image: imageM1, originalPrice: 300, discountedPrice: 250 },
        { id: "mercury-cone-vase", name: "MERCURY VASE", image: imageM2, originalPrice: 300, discountedPrice: 250 }
    ];
