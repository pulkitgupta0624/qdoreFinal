...
const ObjectDecor = () => {
    const products = [
        { id: "the-globe", name: "THE GLOBE", image: image1, originalPrice: 300, discountedPrice: 250 },
    ];
                        ...
                        >
                            ...
                            <div className="p-4 flex flex-col justify-between h-full">
                                ...
                                <div className="mt-4 flex justify-between">
                                    <button
                                        onClick={() => handleNavigation(product)}
                                        className="bg-black text-white text-xl px-5 py-2 rounded transition-transform duration-300 hover:scale-105"
                                    >
                                        Buy Now
                                    </button>
                                    <button
